...
launch_bar() {
    ...
    polybar main -c /home/andrew/.config/bspwm/themes/default/polybar/config.ini -r &
    polybar second -c /home/andrew/.config/bspwm/themes/default/polybar/config.ini -r &
	# Launch the bar
